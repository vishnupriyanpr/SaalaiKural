...
2. You'll see a **Webhook URL** section showing:
   - **Test URL**: `https://<your-instance>.app.n8n.cloud/webhook-test/roadwatch-chat`
   - **Production URL**: `https://<your-instance>.app.n8n.cloud/webhook/roadwatch-chat`
3. Copy the **Test URL**
...
```bash
curl -X POST "https://<your-instance>.app.n8n.cloud/webhook-test/roadwatch-chat" \
...
```powershell
Invoke-RestMethod -Method POST -Uri "https://<your-instance>.app.n8n.cloud/webhook-test/roadwatch-chat" -ContentType "application/json" -Body '{"message": "How do I report a pothole?"}'
```
...
3. The production URL is: `https://<your-instance>.app.n8n.cloud/webhook/roadwatch-chat`
...
```javascript
const WEBHOOK_URL = 'https://<your-instance>.app.n8n.cloud/webhook/roadwatch-chat';
```
